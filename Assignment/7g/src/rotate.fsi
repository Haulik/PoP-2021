...
///<param name="b">The board, a char list.</param>
///<param name="p">The position of the top-left corner of the rotating square. The position must be a valid rotation position, so validRotate should always be checked before calling rotate.</param>
...
///<returns>A new board, where the fields at the position p have been rotated clockwise.</returns>
